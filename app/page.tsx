      ...
      >
        ...
        <header style={{ marginBottom: "40px" }}>
          ...
          >
            ...
            <span style={{ color: "#f87171", fontWeight: 600 }}>KILL</span> —{" "}
        ...
        <section style={{ marginBottom: "48px" }}>
          ...
          >
            To use it: <strong>paste a signal → submit → read the verdict</strong>.
            Repeat for all your ideas and only build what comes back as{" "}
            <span style={{ color: "#22c55e", fontWeight: 600 }}>BUILD</span>.
          </p>
        </section>
        ...
        >
          Part of{" "}
          <span style={{ color: "#ffffff" }}>NextWave AI Suite</span> · Secure
          payments via Stripe
        </footer>
      </div>
    </main>
